<template>
  <div class="main-div-steps">
    <t-steps style="width: 70%" :current="currentStep" @change="stepChange">
      ...
      <t-step-item title="选择座位">
        <template #icon>
          <svg class="t-icon t-icon-verify icon-margin" style="margin-top: 1px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1.5em" height="1.5em">
